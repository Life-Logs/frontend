...
import DaySelectAndWeekDaySelect from '../routineAdd/DaySelectAndWeekDaySelect';

interface RoutineEditProps {
  setEditModal: React.Dispatch<React.SetStateAction<boolean>>;
}

export default function RoutineEdit({ setEditModal }: RoutineEditProps) {
  ...
  return (
    <Body>
      ...
      <InputContents>
        ...
        <ConfirmAndCancle>
          <Cancel onClick={() => setEditModal(false)}>취소</Cancel>
          <Confirm
            onClick={() => {
